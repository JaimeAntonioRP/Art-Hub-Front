...
const TEAM: Member[] = [
  ...
  },
  {
    ...
    bio: "Dirige la estrategia de marca y posicionamiento internacional. Trabaja con organismos como UNESCO y el Ministerio de Cultura para amplificar el alcance del arte peruano.",
    institutions: ["UNESCO", "Ministerio de Cultura Perú", "UNSAAC"],
    color: "#B8653B",
  },
  {

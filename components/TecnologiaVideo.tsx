...
function VideoPlayer() {
  ...
  return (
    <>
      ...
      <video
        ref={videoRef}
        src="/videos/visioncomputacional.mp4"
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <span style={{ color: "rgba(237,227,204,0.75)", fontSize: 12, fontFamily: "'Inter','Geist',sans-serif" }}>
            Visión computacional — análisis de pincelada
          </span>
...
/* portal: mounts inside .demo.ia */
export default function TecnologiaVideo() {
  const [target, setTarget] = useState<Element | null>(null);

  useEffect(() => {
    const el = document.querySelector(".demo.ia");
    if (el) setTarget(el);
  }, []);
